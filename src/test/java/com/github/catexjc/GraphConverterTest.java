...
public class GraphConverterTest {
    ...
    public Object[][] hasEdgeCases() {
        DirectedGraph<String, String> g = GraphConverter.toGraph(Fixtures.chainCategory());
        return new Object[][] {
            { g, "A", "B", true  },
            { g, "B", "C", true  },
            { g, "A", "C", true  },
    ...
    public void testRoundTripGraphToCategory() {
        ...
        var cat2 = GraphConverter.fromGraph(g);
        // objects must match
        assertEquals(cat2.getObjects().size(), 2);
        // identities were added back
        List<String> errors = cat2.validate();
    ...
    public void testEdgesFromA() {
        var g = GraphConverter.toGraph(Fixtures.chainCategory());
        List<DirectedGraph.Edge<String, String>> from = g.edgesFrom("A");
    ...
    public void testEdgesTo() {
        var g = GraphConverter.toGraph(Fixtures.chainCategory());
        List<DirectedGraph.Edge<String, String>> to = g.edgesTo("C");
